...
public class WeightSorting implements Comparator<Animal>
{
	/*
	...
	{
		/**
		 * Sorting the Animal based on animal weight
		 */
		return Double.compare(a1.getAnimalWeight(),a2.getAnimalWeight());
	}
	...
	public static void main(String[] args) 
	{
		 ...
		 */
		Collections.sort(animals,new WeightSorting());
		 ...
		 */
		System.out.println("ArrayList Objects after sorting based on the Weight");
